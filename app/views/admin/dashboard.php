        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-bold fs-7">Total
                        <?= count($allUsers)?> accounts
                    </span>
                </h3>
                ...
                <div class="table-responsive">
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="7" class="text-center text-muted py-10">No users found.</td>
                            </tr>
                            <?php
else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-45px me-5">
                                            ...
                                            <div class="symbol-label fs-3 bg-light-success text-success fw-bold">
                                ...
                                <td>
                                    <span class="text-muted fw-bold fs-7">
                                        <?=!empty($user['last_logout']) ? date('d M Y h:i A', strtotime($user['last_logout'])) : '<span class="badge badge-light-secondary" style="color: #f17b7bff;">Never</span>'?>
                                    </span>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <?php if (($user['role'] ?? '') !== 'admin'): ?>
                                        <a href="<?= BASE_URL?>/admin/users/permissions/<?= $user['hash_id']?>"
                                        ...
                                        <a href="<?= BASE_URL?>/admin/users/delete/<?= $user['hash_id']?>"
                                        ...
                                        <span class="text-muted fs-8">System Admin</span>
                                        <?php
        endif; ?>
                                    </div>
                                </td>
